...
//                .tag(getString(R.string.global_tag))                   // Specify TAG, default: "X-LOG"
            ...
            //val filePrinter = FilePrinter.Builder(File(getExternalStorageDirectory(), "xbreezemohanmetallogsample").path)// Printer that print the log to the file system
            val filePrinter = FilePrinter.Builder(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample").path)// Printer that print the log to the file system
