package com.breezemohanmetal.features.dashboard.presentation
...
import com.breezemohanmetal.*
import com.breezemohanmetal.R
import com.breezemohanmetal.app.*
import com.breezemohanmetal.app.NewFileUtils.browseDocuments
import com.breezemohanmetal.app.NewFileUtils.browsePDFDocuments
import com.breezemohanmetal.app.NewFileUtils.getExtension
import com.breezemohanmetal.app.domain.*
import com.breezemohanmetal.app.types.DashboardType
import com.breezemohanmetal.app.types.FragType
import com.breezemohanmetal.app.types.TopBarConfig
import com.breezemohanmetal.app.uiaction.DisplayAlert
import com.breezemohanmetal.app.utils.*
import com.breezemohanmetal.app.utils.AppUtils.Companion.isProfile
import com.breezemohanmetal.base.BaseResponse
import com.breezemohanmetal.base.presentation.BaseActivity
import com.breezemohanmetal.base.presentation.BaseFragment
import com.breezemohanmetal.features.NewQuotation.*
import com.breezemohanmetal.features.NewQuotation.api.GetQuotRegProvider
import com.breezemohanmetal.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezemohanmetal.features.SearchLocation.SearchLocationFragment
import com.breezemohanmetal.features.SearchLocation.locationInfoModel
import com.breezemohanmetal.features.TA.ViewAllTAListFragment
import com.breezemohanmetal.features.achievement.AchievementFragment
import com.breezemohanmetal.features.activities.presentation.*
import com.breezemohanmetal.features.addAttendence.*
import com.breezemohanmetal.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezemohanmetal.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezemohanmetal.features.addAttendence.model.GetReportToFCMResponse
import com.breezemohanmetal.features.addAttendence.model.GetReportToResponse
import com.breezemohanmetal.features.addAttendence.model.Leave_list_Response
import com.breezemohanmetal.features.addorder.presentation.AddOrderFragment
...
import com.breezemohanmetal.features.addshop.presentation.AddShopFragment
import com.breezemohanmetal.features.addshop.presentation.OTPVerificationDialog
import com.breezemohanmetal.features.addshop.presentation.ScanImageFragment
import com.breezemohanmetal.features.addshop.presentation.ShowCardDetailsDialog
import com.breezemohanmetal.features.alarm.model.AlarmData
import com.breezemohanmetal.features.alarm.presetation.AttendanceReportFragment
import com.breezemohanmetal.features.alarm.presetation.PerformanceReportFragment
import com.breezemohanmetal.features.alarm.presetation.VisitReportDetailsFragment
import com.breezemohanmetal.features.alarm.presetation.VisitReportFragment
import com.breezemohanmetal.features.attendance.AttendanceFragment
import com.breezemohanmetal.features.attendance.api.AttendanceRepositoryProvider
import com.breezemohanmetal.features.attendance.model.AttendanceRequest
import com.breezemohanmetal.features.attendance.model.AttendanceResponse
import com.breezemohanmetal.features.averageshop.presentation.AverageShopFragment
import com.breezemohanmetal.features.avgorder.presentation.AverageOrderFragment
import com.breezemohanmetal.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezemohanmetal.features.beatCustom.TeamBeatListFragment
import com.breezemohanmetal.features.billing.presentation.AddBillingFragment
import com.breezemohanmetal.features.billing.presentation.BillingDetailsFragment
import com.breezemohanmetal.features.billing.presentation.BillingListFragment
import com.breezemohanmetal.features.changepassword.presentation.ChangePasswordDialog
import com.breezemohanmetal.features.chat.model.ChatListDataModel
import com.breezemohanmetal.features.chat.model.ChatUserDataModel
import com.breezemohanmetal.features.chat.model.GroupUserDataModel
import com.breezemohanmetal.features.chat.presentation.*
import com.breezemohanmetal.features.chatbot.presentation.ChatBotFragment
import com.breezemohanmetal.features.chatbot.presentation.ChatBotShopListFragment
import com.breezemohanmetal.features.chatbot.presentation.ReportsFragment
import com.breezemohanmetal.features.chatbot.presentation.SelectLanguageDialog
import com.breezemohanmetal.features.commondialog.presentation.CommonDialog
import com.breezemohanmetal.features.commondialog.presentation.CommonDialogClickListener
import com.breezemohanmetal.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezemohanmetal.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezemohanmetal.features.commondialogsinglebtn.OnDialogClickListener
import com.breezemohanmetal.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezemohanmetal.features.contacts.ActivityDtlsFrag
import com.breezemohanmetal.features.contacts.AddOpptFrag
import com.breezemohanmetal.features.contacts.ContactDtls
import com.breezemohanmetal.features.contacts.ContactGr
import com.breezemohanmetal.features.contacts.ContactsAddFrag
import com.breezemohanmetal.features.contacts.ContactsFrag
import com.breezemohanmetal.features.contacts.SchedulerAddFormFrag
import com.breezemohanmetal.features.contacts.SchedulerViewFrag
import com.breezemohanmetal.features.contacts.TemplateAddFrag
import com.breezemohanmetal.features.contacts.TemplateViewFrag
import com.breezemohanmetal.features.contacts.ViewCrmOpptFrag
import com.breezemohanmetal.features.dailyPlan.prsentation.AllShopListFragment
import com.breezemohanmetal.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezemohanmetal.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezemohanmetal.features.damageProduct.ShopDamageProductListFrag
import com.breezemohanmetal.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezemohanmetal.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezemohanmetal.features.dashboard.presentation.model.ContentListResponseModel
import com.breezemohanmetal.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezemohanmetal.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezemohanmetal.features.device_info.presentation.DeviceInfoListFragment
import com.breezemohanmetal.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezemohanmetal.features.document.DocumentRepoFeatureNewFragment
import com.breezemohanmetal.features.document.presentation.DocumentListFragment
import com.breezemohanmetal.features.document.presentation.DocumentTypeListFragment
import com.breezemohanmetal.features.document.presentation.OpenFileWebViewFragment
import com.breezemohanmetal.features.dymanicSection.presentation.AddDynamicFragment
import com.breezemohanmetal.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezemohanmetal.features.dymanicSection.presentation.DynamicListFragment
import com.breezemohanmetal.features.dymanicSection.presentation.EditDynamicFragment
import com.breezemohanmetal.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezemohanmetal.features.home.presentation.HomeFragment
import com.breezemohanmetal.features.homelocation.presentation.HomeLocationFragment
import com.breezemohanmetal.features.homelocation.presentation.HomeLocationMapFragment
import com.breezemohanmetal.features.know_your_state.KnowYourStateFragment
import com.breezemohanmetal.features.lead.LeadFrag
import com.breezemohanmetal.features.lead.ViewLeadFrag
import com.breezemohanmetal.features.leaderboard.LeaderBoardFrag
import com.breezemohanmetal.features.leaveapplynew.LeaveHome
import com.breezemohanmetal.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezemohanmetal.features.localshops.LocalShopListFragment
import com.breezemohanmetal.features.localshops.LocalShopListMapFragment
import com.breezemohanmetal.features.localshops.NearByShopsMapFragment
import com.breezemohanmetal.features.location.*
import com.breezemohanmetal.features.location.api.LocationRepoProvider
import com.breezemohanmetal.features.location.model.*
import com.breezemohanmetal.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezemohanmetal.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezemohanmetal.features.login.ShopFeedbackEntity
import com.breezemohanmetal.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezemohanmetal.features.login.presentation.LoginActivity
import com.breezemohanmetal.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezemohanmetal.features.logoutsync.presentation.LogoutSyncFragment
import com.breezemohanmetal.features.marketAssist.MarketAssistTabFrag
import com.breezemohanmetal.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezemohanmetal.features.marketAssist.ShopListMarketAssistFrag
import com.breezemohanmetal.features.marketing.presentation.MarketingPagerFragment
import com.breezemohanmetal.features.meetinglist.prsentation.MeetingListFragment
import com.breezemohanmetal.features.member.MapViewForTeamFrag
import com.breezemohanmetal.features.member.model.TeamLocDataModel
import com.breezemohanmetal.features.member.model.TeamShopListDataModel
import com.breezemohanmetal.features.member.presentation.*
import com.breezemohanmetal.features.menuBeat.MenuBeatFrag
import com.breezemohanmetal.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezemohanmetal.features.micro_learning.presentation.MicroLearningListFragment
import com.breezemohanmetal.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezemohanmetal.features.myallowancerequest.MyallowanceRequestFragment
import com.breezemohanmetal.features.myjobs.model.CustomerDataModel
import com.breezemohanmetal.features.myjobs.presentation.*
import com.breezemohanmetal.features.mylearning.MyLearningFragment
import com.breezemohanmetal.features.mylearning.SearchLmsFrag
import com.breezemohanmetal.features.mylearning.VideoPlayLMS
import com.breezemohanmetal.features.myorder.presentation.MyOrderListFragment
import com.breezemohanmetal.features.myprofile.presentation.MyProfileFragment
import com.breezemohanmetal.features.nearbyshops.api.ShopListRepositoryProvider
import com.breezemohanmetal.features.nearbyshops.model.ShopData
import com.breezemohanmetal.features.nearbyshops.model.ShopListResponse
import com.breezemohanmetal.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezemohanmetal.features.nearbyshops.presentation.BeatListFragment
import com.breezemohanmetal.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezemohanmetal.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezemohanmetal.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezemohanmetal.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezemohanmetal.features.newcollection.CollectionDetailsStatusFragment
import com.breezemohanmetal.features.newcollection.CollectionShopListFragment
import com.breezemohanmetal.features.newcollection.NewCollectionListFragment
import com.breezemohanmetal.features.newcollectionreport.*
import com.breezemohanmetal.features.notification.NotificationFragment
import com.breezemohanmetal.features.orderITC.CartListFrag
import com.breezemohanmetal.features.orderITC.OrderListFrag
import com.breezemohanmetal.features.orderITC.ProductListFrag
import com.breezemohanmetal.features.orderITC.ViewNewOrdHisAllFrag
import com.breezemohanmetal.features.orderITC.ViewNewOrdHistoryFrag
import com.breezemohanmetal.features.orderITC.ViewOrdDtls
import com.breezemohanmetal.features.orderList.NewDateWiseOrderListFragment
import com.breezemohanmetal.features.orderList.NewOrderListFragment
import com.breezemohanmetal.features.orderList.OrderListFragment
import com.breezemohanmetal.features.orderdetail.presentation.OrderDetailFragment
import com.breezemohanmetal.features.orderhistory.ActivityMapFragment
import com.breezemohanmetal.features.orderhistory.OrderhistoryFragment
import com.breezemohanmetal.features.orderhistory.TimeLineFragment
import com.breezemohanmetal.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezemohanmetal.features.orderhistory.model.LocationData
import com.breezemohanmetal.features.pendinglocationinout.PendingOutLocationFrag
import com.breezemohanmetal.features.performance.GpsStatusFragment
import com.breezemohanmetal.features.performance.PerformanceFragment
import com.breezemohanmetal.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezemohanmetal.features.performance.model.UpdateGpsInputParamsModel
import com.breezemohanmetal.features.performanceAPP.OwnPerformanceFragment
import com.breezemohanmetal.features.performanceAPP.PerformanceAppFragment
import com.breezemohanmetal.features.performanceAPP.allPerformanceFrag
import com.breezemohanmetal.features.permissionList.ViewPermissionFragment
import com.breezemohanmetal.features.photoReg.*
import com.breezemohanmetal.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezemohanmetal.features.quotation.presentation.*
import com.breezemohanmetal.features.reimbursement.presentation.*
import com.breezemohanmetal.features.report.presentation.*
import com.breezemohanmetal.features.returnsOrder.*
import com.breezemohanmetal.features.settings.presentation.SettingsFragment
import com.breezemohanmetal.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezemohanmetal.features.shopdetail.presentation.*
import com.breezemohanmetal.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezemohanmetal.features.stock.StockDetailsFragment
import com.breezemohanmetal.features.stock.StockListFragment
import com.breezemohanmetal.features.stockAddCurrentStock.AddShopStockFragment
import com.breezemohanmetal.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezemohanmetal.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezemohanmetal.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezemohanmetal.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezemohanmetal.features.stockCompetetorStock.CompetetorStockFragment
import com.breezemohanmetal.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezemohanmetal.features.survey.SurveyFrag
import com.breezemohanmetal.features.survey.SurveyViewDtlsFrag
import com.breezemohanmetal.features.survey.SurveyViewFrag
import com.breezemohanmetal.features.task.presentation.AddTaskFragment
import com.breezemohanmetal.features.task.presentation.CalenderTaskFragment
import com.breezemohanmetal.features.task.presentation.EditTaskFragment
import com.breezemohanmetal.features.task.presentation.TaskListFragment
import com.breezemohanmetal.features.taskManagement.TaskManagementFrag
import com.breezemohanmetal.features.taskManagement.ViewTaskManagementFrag
import com.breezemohanmetal.features.timesheet.presentation.AddTimeSheetFragment
import com.breezemohanmetal.features.timesheet.presentation.EditTimeSheetFragment
import com.breezemohanmetal.features.timesheet.presentation.TimeSheetListFragment
import com.breezemohanmetal.features.viewAllOrder.CartFragment
import com.breezemohanmetal.features.viewAllOrder.OrderTypeListFragment
import com.breezemohanmetal.features.viewAllOrder.ViewAllOrderListFragment
import com.breezemohanmetal.features.viewAllOrder.ViewCartFragment
import com.breezemohanmetal.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezemohanmetal.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezemohanmetal.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezemohanmetal.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezemohanmetal.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezemohanmetal.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezemohanmetal.features.viewPPDDStock.ViewOutstandingFragment
import com.breezemohanmetal.features.viewPPDDStock.ViewPPDDListFragment
import com.breezemohanmetal.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezemohanmetal.features.viewPPDDStock.ViewStockFragment
import com.breezemohanmetal.features.weather.presentation.WeatherFragment
import com.breezemohanmetal.mappackage.MapActivity
import com.breezemohanmetal.mappackage.MapActivityWithoutPath
import com.breezemohanmetal.mappackage.SendBrod
import com.breezemohanmetal.widgets.AppCustomEditText
import com.breezemohanmetal.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezemohanmetallogsample/log").path);
            //27-09-2021
//            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log").path);
...
//                BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath="/data/user/0/com.breezemohanmetal/files/Fsmlog.html"
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
