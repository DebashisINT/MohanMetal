package com.breezemohanmetal.features.permissionList
...
import com.breezemohanmetal.test.viewPermission.AdapterViewPermission
        ...
        for(i in 0..list.size-1){
            if(list1.get(i)!="android.permission.ACCESS_GPS") {
                var obj: PermissionDetails = PermissionDetails(list1.get(i).replace("android.permission.", "").replace("_", " ")
                        ...
                        replace("com.breezemohanmetal.permission.C2D",""), list.get(i))
