package com.breezemohanmetal.features.logoutsync.presentation
...
import com.breezemohanmetal.app.AppDatabase
...
import com.breezemohanmetal.app.utils.Toaster
import com.breezemohanmetal.base.BaseResponse
import com.breezemohanmetal.base.presentation.BaseActivity
import com.breezemohanmetal.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezemohanmetal.features.billing.api.AddBillingRepoProvider
import com.breezemohanmetal.features.billing.model.AddBillingInputParamsModel
...
import com.breezemohanmetal.features.dashboard.presentation.ReasonDialog
...
import com.breezemohanmetal.features.document.model.AddEditDocumentInputParams
import com.breezemohanmetal.features.document.model.DocumentAttachmentModel
...
import com.breezemohanmetal.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezemohanmetal.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezemohanmetal.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezemohanmetal.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezemohanmetal.features.orderhistory.model.*
...
import com.breezemohanmetal.features.quotation.model.AddQuotInputModel
import com.breezemohanmetal.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezemohanmetal.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezemohanmetal.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezemohanmetal.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezemohanmetal.features.timesheet.model.AddTimeSheetInputModel
import com.breezemohanmetal.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezemohanmetal.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezemohanmetal.features.viewAllOrder.model.AddOrderInputProductList
import com.breezemohanmetal.mappackage.SendBrod
import com.breezemohanmetal.widgets.AppCustomTextView
import com.breezemohanmetal.MonitorService
import com.breezemohanmetal.MySingleton
...
import com.breezemohanmetal.features.addshop.presentation.ShopExtraContactReq
...
import com.breezemohanmetal.features.login.model.GetConcurrentUserResponse
...
import com.breezemohanmetal.features.orderITC.SyncDeleteOpptL
import com.breezemohanmetal.features.orderITC.SyncEditOppt
import com.breezemohanmetal.features.orderITC.SyncOppt
import com.breezemohanmetal.features.orderITC.SyncOpptProductL
import com.breezemohanmetal.features.orderITC.SyncOrd
import com.breezemohanmetal.features.orderITC.SyncOrdProductL
import com.breezemohanmetal.features.performance.model.Gps_status_list
import com.breezemohanmetal.features.performance.model.UpdateGpsInputListParamsModel
import com.breezemohanmetal.features.returnsOrder.ReturnProductList
import com.breezemohanmetal.features.returnsOrder.ReturnRequest
import com.breezemohanmetal.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemohanmetallogsample/log.zip").path);
